...
Use the prompt template in `references/image-prompt-template.md`.
...
See `references/biophilic-design-case-study.md` for a worked example showing how this skill would have prevented the 10 errors found in a real one-shot-generated poster on biophilic vs. brutalist spaces.
